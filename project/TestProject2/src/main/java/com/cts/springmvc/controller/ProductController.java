...
@RequestMapping(value = "register", method = RequestMethod.POST)
	public String createUser(@ModelAttribute Product product1,Model m)
	{
		productService1.createProduct(product1);//save(employee)
		 return "registersuccess"; //redirect to request pattern::view
	       }
...
/*	//insertion
			...
			public String createUser(
					@Valid 
					@ModelAttribute Product product1,
					BindingResult br,
					Model m)
			{
				if(br.hasErrors())  
	...
	public String view1(@ModelAttribute Product product1,Model m)
	{
		List<Product> obj=productService1.getemps();
		m.addAttribute("emps",obj);//emps can beaccessin ViewEmp.jsp
			return "UserView";//ViewEmp.jsp
	}
	//deletion
